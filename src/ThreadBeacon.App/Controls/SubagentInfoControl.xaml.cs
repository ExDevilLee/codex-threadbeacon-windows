...
public partial class SubagentInfoControl : UserControl
{
    public static readonly DependencyProperty DetailsProperty = DependencyProperty.Register(
        nameof(Details),
        typeof(SubagentDetailViewModel),
        typeof(SubagentInfoControl),
